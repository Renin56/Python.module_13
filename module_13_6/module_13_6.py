...
kb_btn_calculate = KeyboardButton(text='Рассчитать')
kb_btn_information = KeyboardButton(text='Информация')
kb.add(kb_btn_calculate)
kb.add(kb_btn_information)
...
# inline_kb_btn_calculate = InlineKeyboardButton(text='Рассчитать норму калорий', callback_data='calories')
# inline_kb_btn_formula = InlineKeyboardButton(text='Формула расчёта', callback_data='formulas')

# inline_kb.add(inline_kb_btn_calculate)
# inline_kb.add(inline_kb_btn_formula)
